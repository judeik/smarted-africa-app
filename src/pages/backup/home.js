      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <a href="#audience" className="text-gray-600 hover:text-green-600 font-medium transition-colors">Solutions</a>
            <a href="#testimonials" className="text-gray-600 hover:text-green-600 font-medium transition-colors">Success Stories</a>
            <a href="#team" className="text-gray-600 hover:text-green-600 font-medium transition-colors">Our Team</a>
        ...
        {isMenuOpen && (
          <div className="md:hidden mt-4 pb-4">
            <div className="flex flex-col space-y-4">
              <a href="#features" className="text-gray-600 hover:text-green-600 font-medium py-2" onClick={() => setIsMenuOpen(false)}>Features</a>
              <a href="#audience" className="text-gray-600 hover:text-green-600 font-medium py-2" onClick={() => setIsMenuOpen(false)}>Solutions</a>
              <a href="#testimonials" className="text-gray-600 hover:text-green-600 font-medium py-2" onClick={() => setIsMenuOpen(false)}>Success Stories</a>
              <a href="#team" className="text-gray-600 hover:text-green-600 font-medium py-2" onClick={() => setIsMenuOpen(false)}>Our Team</a>
    ...
    <div className="min-h-screen bg-gradient-to-br from-teal-50 to-gray-100">
      ...
      <section id="audience" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Comprehensive Solutions for Every Learner</h2>
      ...
      <section id="testimonials" className="py-16 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">Partner & Institutional Testimonials</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
      ...
      <section className="py-16 bg-gradient-to-br from-blue-50 to-teal-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 mb-4">ID Camp Innovation Team</h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
